  ...
  const loadProfile = async () => {
    try {
      ...
      setProfileData({
        ...
        year: profile.year ? (profile.year.includes(' Year') ? profile.year : profile.year + ' Year') : '1st Year',
        sem: profile.sem ? (profile.sem.includes(' Semester') ? profile.sem : profile.sem + ' Semester') : '1st Semester',
        password: '',
      });
